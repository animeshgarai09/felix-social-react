...
export const addPostCommentHandler = function (schema, request) {
    ...
    try {
        ...
        console.log("🚀 ~ file: CommentsController.js ~ line 50 ~ addPostCommentHandler ~ postId", postId)
        const { commentData } = JSON.parse(request.requestBody);
        console.log("🚀 ~ file: CommentsController.js ~ line 52 ~ addPostCommentHandler ~ commentData", commentData)
...
export const editPostCommentHandler = function (schema, request) {
    ...
    try {
        ...
        const { commentData } = JSON.parse(request.requestBody);
        const post = schema.posts.findBy({ _id: postId }).attrs;
        console.log("🚀 ~ file: CommentsController.js ~ line 101 ~ editPostCommentHandler ~ post", post)
        const commentIndex = post.comments.findIndex(
            (comment) => comment._id === commentId
        );
        console.log("🚀 ~ file: CommentsController.js ~ line 104 ~ editPostCommentHandler ~ commentIndex", commentIndex)
...
export const deletePostCommentHandler = function (schema, request) {
    ...
    try {
        ...
        const { postId, commentId } = request.params;
        console.log("🚀 ~ file: CommentsController.js ~ line 149 ~ deletePostCommentHandler ~ commentId", commentId)
        console.log("🚀 ~ file: CommentsController.js ~ line 149 ~ deletePostCommentHandler ~ postId", postId)
        const post = schema.posts.findBy({ _id: postId }).attrs;
        const commentIndex = post.comments.findIndex(
            (comment) => comment._id === commentId
        );
